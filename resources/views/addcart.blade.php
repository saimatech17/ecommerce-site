    ...
    <div class="col-md-6">
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active"> <img class="d-block w-100" src="sitecss/img/c51.jpg" alt="First slide"> </div>
          <div class="carousel-item"> <img class="d-block w-100" src="sitecss/img/c52.jpg" alt="Second slide"> </div>
        </div>
...
<div class="container">
   ...
   <div class="row mt-5">
   	<div class="col-md-3">
   		<div class="card">
   			<img class="card-img-top img-fluid" src="sitecss/img/c61.jpg">
   	...
   	<div class="col-md-3">
   		<div class="card">
   			<img class="card-img-top img-fluid" src="sitecss/img/c94.jpg">
   			<div class="card-title">
   				<h4>GYM Tops</h4>
   			</div> 
   			<div class="card-text">
   	...
   	<div class="col-md-3">
   		<div class="card">
   			<img class="card-img-top img-fluid" src="sitecss/img/c132.jpg">
   			<div class="card-title">
   				<h4>GYM Tops</h4>
   			</div> 
   			<div class="card-text">
   	...
   	<div class="col-md-3">
   		<div class="card">
   			<img class="card-img-top img-fluid" src="sitecss/img/c172.jpg">
   			<div class="card-title">
   				<h4>GYM Tops</h4>
   			</div> 
   			<div class="card-text">
...
<div class="container mt-5 mb-5">
	...
	<div class="row mt-5 mb-5">
		<div class="media">
  <img class="mr-3" src="sitecss/img/11.jpg" alt="Generic placeholder image">
  <div class="media-body">
	...
	<div class="row mb-5">
    <div class="media"> <img class="mr-3" src="sitecss/img/12.jpg" alt="Generic placeholder image">
      <div class="media-body">
  ...
  <div class="row mb-5">
    <div class="media"> <img class="mr-3" src="sitecss/img/13.jpg" alt="Generic placeholder image">
      <div class="media-body">
  ...
  <div class="row mb-5">
    <div class="media"> <img class="mr-3" src="sitecss/img/14.jpg" alt="Generic placeholder image">
      <div class="media-body">
