  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="sitecss/img/shop 1.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="sitecss/img/shop 2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
 ...
 <!--counter end-->     
   	...
   	<div class="owl-carousel">
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c101.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c111.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c121.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c131.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c141.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c151.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c161.jpg">
   				<div class="card-body">
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/c31.jpg">
   				<div class="card-body">
   ...
   <div class="container">
   	<div class="owl-carousel">
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M1.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product1</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M2.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product2</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M3.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product3</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M4.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product4</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M5.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product5</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M6.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product6</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   		...
   		<div>
   			<div class="card product-card">
   				<img class="card-img-top img-fluid" src="sitecss/img/product/M7.jpg">
   				<div class="card-body">
   					<div class="card-title"> Product7</div>
   					<div class="card-text">
   						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto hic nobis molestias rem eius assumenda.<br/>
   ...
   <div class="container mt-5 mb-5">
   	<div class="owl-carousel owl-theme">
   		<div class="item"><img src="sitecss/img/1.png" class="img-fluid"></div>
   		<div class="item"><img src="sitecss/img/2.png" class="img-fluid"></div>
   		<div class="item"><img src="sitecss/img/3.png" class="img-fluid"></div>
   		<div class="item"><img src="sitecss/img/4.png" class="img-fluid"></div>
   		<div class="item"><img src="sitecss/img/5.png" class="img-fluid"></div>
   	</div>
   </div>
 ...
 <div class="container mt-5 mb-5">
 	<div class="row">
 		<div class="col-md-6 payment-method">
 			...
 			<img class="img-fluid" src="sitecss/img/payment_methods.jpg">
 		</div>
   	...
   	<div class="container pt-5 pb-5">
   		<div class="row">
   			...
   			<h3>Latest products</h3>
   				<div class="media mt-5"> <img class="mr-3 img-fluid" src="sitecss/img/footer images/c31.jpg" alt="">
   				...
   				<div class="media mt-5"> <img class="mr-3 img-fluid" src="sitecss/img/footer images/c51.jpg" alt="">
   				<div class="media-body">
   					<h5>Woman's Top</h5>
   					<del>$80</del> &nbsp; $70
   				</div>
   			...
   			<h3>Top Rated products</h3>
   				<div class="media mt-5"> <img class="mr-3 img-fluid" src="sitecss/img/footer images/M2.jpg" alt="">
   				<div class="media-body">
   					<h5>Man's Dress</h5>
   					<del>$80</del> &nbsp; $70
   				</div>
   				...
   				<div class="media mt-5"> <img class="mr-3 img-fluid" src="sitecss/img/footer images/M7.jpg" alt="">
   				<div class="media-body">
